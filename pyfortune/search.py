...
class Search():
    ...
    def __init__(self, username, password, group=None, number=None):
        ...
        detail_data = pd.DataFrame(columns=["one_money", "subscription", "title",
                                            "title_left", "title_mid", "title_right", "total_money", "winning"], index=None)
        ...
        data = pd.concat([detail_data[["one_money", "subscription", "title_left"]],
                          split_data, detail_data[["title_right", "total_money", "winning"]]], axis=1)
        data.columns = ["one_money", "subscription", "member",
                        "data", "venue", "part", "title", "total_money", "winning"]
        self.data = data
